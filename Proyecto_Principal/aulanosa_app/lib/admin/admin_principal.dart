...
class _AdminPrincipalState extends State<AdminPrincipal> {
  ...
  List opciones = [
    Opcion(
        nombre: 'Notas',
        icono: Icon(Icons.checklist_rtl, size: 50),
        ruta: 'notas'),
    Opcion(
        nombre: 'Empresa',
        icono: Icon(Icons.business_center_sharp, size: 50),
        ruta: 'empresa'),
    Opcion(
        nombre: 'Proyecto',
        icono: Icon(Icons.auto_awesome_motion_sharp, size: 50),
        ruta: 'proyecto'),
    Opcion(
        nombre: 'Tutorias',
        icono: Icon(Icons.co_present_outlined, size: 50),
        ruta: 'tutorias'),
    Opcion(
        nombre: 'Mensajes',
        icono: Icon(Icons.message, size: 50),
        ruta: 'mensajes'),
    Opcion(
        nombre: 'Ajustes',
        icono: Icon(Icons.settings, size: 50),
        ruta: 'ajustes')
  ];
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        globales.redireccion =
                            PrincipalAdminButtons.getListButtons()[index].ruta;
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            color: PrincipalAdminButtons.getListButtons()[index]
                                .color,
